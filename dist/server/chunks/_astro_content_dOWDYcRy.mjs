...
import { V as VALID_INPUT_FORMATS } from './_astro_assets_Dzdt6vYx.mjs';
import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, e as renderUniqueStylesheet, f as renderScriptElement, g as createHeadAndContent, b as renderComponent } from './astro/server_9v0MxHWw.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C6a5uUt8.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Dzdt6vYx.mjs').then(n => n._);
